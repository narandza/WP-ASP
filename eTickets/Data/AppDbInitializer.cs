            ...
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Movies.Any())
                {
                    context.Movies.AddRange(new List<Movie>()
                    {
                        ...
                        new Movie()
                        {
                            Name = "Dva sata kvalitetnog programa",
                            Description = "Opis",
                            Price = 29.50,
        ...
        public static async Task SeedUsersAndRolesAsync(IApplicationBuilder applicationBuilder)
        {
            using(var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (adminUser == null)
                {
                    ...
                    {
                        FullName = "Dimitrije Jovanovic",
                        UserName = "admin",
                        Email = adminUserEmail,
                        EmailConfirmed = true
                    };
                    await userManager.CreateAsync(newAdminUser, "Sifra@123?");
                ...
                if (appUser == null)
                {
                    ...
                    await userManager.CreateAsync(newAppUser, "Sifra@123?");
